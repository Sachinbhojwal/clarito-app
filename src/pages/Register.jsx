                ...
                <div className="relative h-screen">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-center items-center text-white px-10">
                    ...
                    <p className="mt-4 text-center max-w-md text-lg">
                      Join India's trusted home service platform.
                    </p>
            ...
            >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <label
                    className={`border rounded-xl p-4 cursor-pointer text-center ${formData.role === "customer"
                  ...
                  <label
                    className={`border rounded-xl p-4 cursor-pointer text-center ${formData.role === "provider"
                      ? "border-yellow-500 bg-yellow-50"
                      : "border-gray-300"
                      }`}
                  >
